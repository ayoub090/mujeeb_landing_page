...
ALLOWED_TRANSITIONS: dict[FSMState, set[FSMState]] = {
    ...
    FSMState.modify_variants: {FSMState.awaiting_confirmation},
    FSMState.awaiting_address_choice: {
        FSMState.reverse_geo,
        FSMState.llm_parser_strict,
    },
    FSMState.reverse_geo: {FSMState.confirm_address_text},
    FSMState.llm_parser_strict: {FSMState.confirm_address_text, FSMState.awaiting_address_choice},
    FSMState.confirm_address_text: {FSMState.awaiting_address_choice, FSMState.upsell_pitch},
    FSMState.upsell_pitch: {FSMState.final_store_sync},
