...
export type Summary = {total:number; confirmed:number; cancelled:number; human_follow_up:number; confirmation_rate:number; plan:string; orders_this_month:number; free_pilot_limit:number|null; free_pilot_remaining:number|null};
